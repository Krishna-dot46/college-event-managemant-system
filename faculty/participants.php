            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Technical Games - Participants</h4>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT gr.registration_id, g.title, gr.student_name, gr.college, gr.department, 
                                                    ...
                                                    ORDER BY g.title, gr.student_name";
                                            ...
                                            if(!mysqli_num_rows($query) > 0) {
                                                ...
                                                while($rows = mysqli_fetch_array($query)) {
                                                    echo '<tr>
                                                        ...
                                                        <td>'.$rows['contact'].'</td>
                                                        <td>'.$rows['email'].'</td>
                                                        <td><a href="add_winner.php?reg_id='.$rows['registration_id'].'" class="btn btn-info btn-sm">Add Winner</a></td>
                                                    </tr>';
                                                    $i++;
                                                }
                                            }
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Non-Technical Games - Participants</h4>
                                <div class="table-responsive m-t-20">
