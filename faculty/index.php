...
if (isset($_POST['submit'])) {
  ...
  if (!empty($_POST["submit"])) {
    $loginquery = "SELECT * FROM faculty WHERE (username='$username' OR email='$username') && password='" . md5($password) . "'";
...
<body>
  <div class="container">
    ...
    <div class="form">
      <div class="thumbnail">
        <h2 style="color: #2c3e50; font-size: 1.5rem; margin-bottom: 1rem;">Welcome Faculty!</h2>
        <p style="color: #7f8c8d; font-size: 1rem;">Please login to access the faculty portal</p>
      </div>
