...
if(isset($_POST['action'])) {
    ...
    if($new_status) {
        $update_sql = "UPDATE game_registration SET registration_status = ? WHERE registration_id = ?";
        $update_stmt = mysqli_prepare($db, $update_sql);
        mysqli_stmt_bind_param($update_stmt, "si", $new_status, $registration_id);
        mysqli_stmt_execute($update_stmt);
        
        // Redirect to refresh the page
        header("location: registration_details.php?id=" . $registration_id);
        exit();
    }
}
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- Action Buttons -->
                                        <?php if(strtolower($row['registration_status']) == 'pending'): ?>
                                        <div class="action-buttons">
                                            <form method="POST" style="display: inline;">
                                                <button type="submit" name="action" value="approve" class="btn btn-approve">
                                                    <i class="fa fa-check"></i> Approve Registration
                                                </button>
                                            </form>
                                            <form method="POST" style="display: inline;">
