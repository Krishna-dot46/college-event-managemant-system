                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($query) == 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    if (!empty($rows['img']) && file_exists("games_img/games/" . $rows['img'])) {
                                                        echo '<img src="games_img/games/' . htmlspecialchars($rows['img']) . '" class="img-fluid" style="max-height:100px;" alt="' . htmlspecialchars($rows['title']) . '">';
                                                    } else {
                                                    ...
                                                    echo '</td>
                                                        <td style="white-space: nowrap; text-align: center;">
                                                            <div class="btn-group" role="group" style="display: inline-flex; gap: 5px;">
                                                                <a href="delete_game.php?game_id=' . htmlspecialchars($rows['game_id']) . '" class="btn btn-danger btn-flat btn-addon btn-sm" style="min-width: 90px;">
                                                                    <i class="fa fa-trash-o"></i> Delete
                                                                </a>
                                                                <a href="update_game.php?game_id=' . htmlspecialchars($rows['game_id']) . '" class="btn btn-info btn-flat btn-addon btn-sm" style="min-width: 90px;">
        ...
        $(document).ready(function() {
            ...
            var table = $('#myTable').DataTable({
                ...
                "drawCallback": function() {
                    ...
                    $('.delete-game').off('click').on('click', function(e) {
                        e.preventDefault();
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    ...
                                    window.location.href = 'delete_game.php?game_del=' + gameId;
                                });
                            }
                        });
                    });
